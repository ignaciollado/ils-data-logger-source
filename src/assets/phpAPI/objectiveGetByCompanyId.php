...
(CASE ils_objective.aspectId WHEN 1 THEN ils_energy.nameES ELSE ils_residue.nameES END) as enviromentalDataName,
...
ils_company_delegation.name as delegation 
