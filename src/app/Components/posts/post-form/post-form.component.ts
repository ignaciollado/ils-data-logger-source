...
export class PostFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.formEnergy = this.formBuilder.group({
  ...
  private loadEnergyConsumption(): void {
    let errorResponse: any;
  ...
  saveFormEnergy(): void {
    ...
    if (this.formEnergy.invalid) {
      return;
    }

    this.isValidForm = true;
    this.consumption = this.formEnergy.value;
